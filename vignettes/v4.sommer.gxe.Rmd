...
mix2 <- mme(y~ envIndex, henderson=TRUE,
...
ansDG <- mme(y~Env, henderson=TRUE,
...
# reduced rank model
ansFA <- mme(y~Env, henderson=TRUE,
...
##########
## stage 1
## use mme for dense field trials
##########
data(DT_h2)
DT <- DT_h2
head(DT)
...
##########
## stage 2
## use mme for sparse equation
##########
m <- matrix(1/var(DT2$Estimate, na.rm = TRUE))
ans2 <- mme(Estimate~Env, henderson=TRUE,
