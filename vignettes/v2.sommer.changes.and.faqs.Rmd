...
```
 Since 4.1.2 this shouldn't be a problem since internally the mmer solver adds the missing levels but we leave this for reference for people using older versions of sommer.
